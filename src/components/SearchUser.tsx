...
function SearchUser() {
  ...
  const handleSearch = async () => {
    const Response = await axios.get(
      `${import.meta.env.VITE_API_URL}/user/searchuser/${searchText}`
    );
  ...
  return (
    <div>
      ...
      <label
        htmlFor="my_modal_6"
        className=" border cursor-pointer flex px-2 py-1 size-12 justify-center fixed bottom-35 shadow-lg z-20 right-8 items-center rounded-full bg-[#EDE9D5] border-[#D4CBB8] "
      >
      ...
      <div className="modal overflow-y-auto z-50 " role="dialog">
        <div className="modal-box  ">
          <div className=" border flex px-2 py-1 rounded-full bg-[#EDE9D5] border-[#D4CBB8] ">
            <input
              type="text"
              placeholder=" Search... "
              value={searchText}
  ...
  return (
    <>
      ...
      >
        ...
        <div className="">
          <h1 className=" font-semibold tracking-tighter leading-none">
            {user.fullName}
          </h1>
